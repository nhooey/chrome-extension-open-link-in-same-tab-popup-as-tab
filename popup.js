...
document.getElementById('cb_t1pop').addEventListener('click', function () {
  save_options(true);
});
document.getElementById('cb_t1foc').addEventListener('click', function () {
  save_options(true);
});
document.getElementById('cb_t1tab').addEventListener('click', function () {
  save_options(false);
});
